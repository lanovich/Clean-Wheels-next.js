      ...
      <SliderPrimitive.Root
        ...
        {localValues.map((value, index) => (
          <React.Fragment key={index}>
            ...
            <SliderPrimitive.Thumb className="block h-4 w-4 rounded-full border border-primary/40 bg-slate-100 shadow transition-colors focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50" />
          </React.Fragment>
        ))}
      </SliderPrimitive.Root>
    );
